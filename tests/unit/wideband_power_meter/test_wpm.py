...
def pv_device():
    """
    Fixture to set up the power meter device for testing with a mock Tango database.
    """
    harness = context.ThreadedTestTangoContextManager()
    harness.add_device(
        device_name="test/wpm/1",
        ...
        simulation_mode="1",
        emulation_mode="0",
        emulator_ip_block_id="wideband_power_meter",
...
def test_device_initialization(device_under_test):
    """
    Test that the power meter device initializes correctly.
    """
...
def test_configure_command(device_under_test):
    """
    Test the Configure command of the power meter device.
    """

    config_json = '{"averaging_time": 1.0, "sample_rate": 3960000000, "flagging": 0}'
...
def test_deconfigure_command(device_under_test):
    """
    Test the Deconfigure command of the power meter device.
    """
...
def test_status_command(device_under_test):
    """
    Test the Status command of the power meter device.
    """
...
def test_recover_command(device_under_test):
    """
    Test the Recover command of the power meter device.
    """
